...
internals.errorHandler.prototype.generateGraph = function (context, botToken) {
  context.message.config.botToken = botToken;
  context.message.config.commandName = context.message.commandName;
  var streamGraph = new StreamGraph(context.channels,
    ...
    function (err, response) {
      ...
      botLogger.logger.info('Resonse handler: responseType result', response);
    }
  );
};
