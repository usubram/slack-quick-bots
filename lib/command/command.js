...
externals.Command.prototype.sendResponseToHook = function (purposeId, requestData, response, callback) {
  if (this.hookContext &&
...
internals.getData = function (slackResponse) {
  var commandModel = this.commands[slackResponse.message.command];
  var purpose = this.hook.getHookPurpose(slackResponse.channel);
  this.hookContext = {};
