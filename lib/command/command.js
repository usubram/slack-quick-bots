...
externals.Commands = class {
  ...
  */
  loadEvents () {
    const savedEvents = _.values(this.getEventStore());
  ...
  */
  ...
  /**
  * Function to get timer for applicable command.
  *
  * @param {object} parsedMessage Message returned @link command/message.js.
  * @return {object} timer object.
  */
  getTimer (parsedMessage) {
    return _.get(this.eventStore, parsedMessage.channel +
      '_' + this.getCommandName() + '.timer');
  }

  /**
  * Function to set timer for applicable command.
  *
  * @param {object} parsedMessage Message returned @link command/message.js.
  * @param {function} callback timer callback to be set.
  */
